...
function write_profile_d_script() {
  ...
  local export_line="export PATH=\$HOME/.platform_tools:\$HOME/.platform_tools/ansible:\$HOME/.platform_tools/ansible/bin:\$HOME/.platform_tools/erlang/bin:\$HOME/.platform_tools/elixir/bin:\$PATH
